		...
		// 	console.log("iconSpace: " + iconSpace);
			...
			nvImageMenu.draw([
				...
				},
				{
					tag: 'img',
					id: 'imgwechatfriend',
					src: '/static/images/sharemenu/wechatfriend.png',
					position: {
						top: top1,
						left: left1,
						width: iconWidth,
				...
				},
				{
					tag: 'img',
					id: 'imgwechatmoments',
					src: '/static/images/sharemenu/wechatmoments.png',
					position: {
						top: top1,
						left: left2,
						width: iconWidth,
				...
				},
				{
					tag: 'img',
					id: 'imgweibo',
					src: '/static/images/sharemenu/weibo.png',
					position: {
						top: top1,
						left: left3,
						width: iconWidth,
				...
				},
				{
					tag: 'img',
					id: 'imgqq',
					src: '/static/images/sharemenu/qq.png',
					position: {
						top: top1,
						left: left4,
						width: iconWidth,
				...
				},
				{
					tag: 'img',
					id: 'imgcopyurl',
					src: '/static/images/sharemenu/copyurl.png',
					position: {
						top: top2,
						left: left1,
						width: iconWidth,
				...
				},
				{
					tag: 'img',
					id: 'imgmore',
					src: '/static/images/sharemenu/more.png',
					position: {
						top: top2,
						left: left2,
						width: iconWidth,
